...
const paths: Record<string, string> = {
  ...
  'recruiter': 'M20.94,6.56l-3.32-2.85c-1.39-1.2-3.41-1.35-4.99-0.45l-1.02,0.58l-1.3-1.6c-0.62-0.77-1.56-1.22-2.55-1.22 C6.3,1.02,5.13,1.96,4.68,3.22L4.03,5.03C3.58,6.29,3.95,7.7,5.01,8.6l1.24,1.06c-0.19,0.59-0.29,1.19-0.29,1.79 c0,3.31,2.69,6,6,6c1.23,0,2.4-0.37,3.38-1.03l3.65,3.13c0.77,0.66,1.92,0.59,2.62-0.16l0.26-0.28C22.68,18.3,22.68,17.07,21.94,16.4 L20.94,6.56z M7.78,7.99C7.26,8.42,6.48,8.38,6.03,7.9c-0.46-0.49-0.5-1.25-0.1-1.78l1.3-1.72c0.39-0.52,1.12-0.66,1.67-0.34 l1.02,0.58C10.74,5.08,11.2,6.01,11,6.86L7.78,7.99z', // Telescope-ish
  'warlog': 'M19,3H5C3.9,3,3,3.9,3,5v14c0,1.1,0.9,2,2,2h14c1.1,0,2-0.9,2-2V5C21,3.9,20.1,3,19,3z M12,18 c-0.55,0-1-0.45-1-1v-5c0-0.55,0.45-1,1-1s1,0.45,1,1v5C13,17.55,12.55,18,12,18z M12,9c-0.55,0-1-0.45-1-1S11.45,7,12,7s1,0.45,1,1 S12.55,9,12,9z', // Report/Log
